...
function buildSpeechletResponse(title, output, repromptText, shouldEndSession) {
    return {
        outputSpeech: {
            type: "SSML",
            ssml: '<speak>Hello, my name is <break time="1s"/>Alexa<break time="1s"/>I say tomato, you say<phoneme alphabet="ipa" ph="tomɑto"/><audio src="https://s3.amazonaws.com/alexademos/atag.mp3"/></speak>'
        },
        card: {
            type: "Simple",
